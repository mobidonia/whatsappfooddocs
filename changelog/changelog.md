...
* Option to select payment method at the checkout
...
* 3.0.3 - Remove apps, Logo custom css - file changed is config/config.php
* 3.0.2 - MP4 Video Paly fix, Disable ordering on vendor level, Default theme select, Bug fix on logo save, No working hours[Files](https://paste.laravel.io/61619615-1d64-47f4-9e13-e7d18a3e89a2)
...
* Select Payment method when there are multiple payment options
* Option to not submit order to WhatsApp
...
* 2.7.4 - Admin fixes, compatible with POS [Files](https://paste.laravel.io/d10fffcd-102e-4a1a-be41-54f15ec8035b)
